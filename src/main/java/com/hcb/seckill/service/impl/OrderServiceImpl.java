...
import com.hcb.seckill.dao.OrderDOMapper;
import com.hcb.seckill.dao.SequenceDOMapper;
import com.hcb.seckill.dataobject.OrderDO;
...
import com.hcb.seckill.service.OrderService;
...
public class OrderServiceImpl implements OrderService {
    ...
    @Override
    @Transactional
    public OrderModel createOrder(Integer userId, Integer itemId, Integer amount,Integer promoId) throws BussinessException {
    ...
    String generatorOrderNo(){
        ...
        //获取当前sequence
        int sequence = 0;
        // getSequenceByName() 是for update 操作,查询得到的行会被加 行锁,直到该事务执行前,其他线程不能操作该行.
